...
export const metadata: Metadata = {
  ...
  description: `${siteConfig.gameName} codes status, redemption steps, and source confidence notes.`,
  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <PageIntro
        ...
        title={`${siteConfig.gameName} Codes`}
        description="Use this page as the canonical codes surface. Add only verified codes from official or trusted community sources before launch."
      />
      <AdsterraArticleTop />
      ...
      <section className="mt-10">
        <SectionHeader
          ...
          copy="Code entries stay hidden or marked Needs check until a current source or live test confirms the reward."
        />
          ...
          {activeCodes.length === 0 ? (
            <article className="content-card md:col-span-2">
              ...
              <p className="mt-3 text-white/70">
                This page is ready for updates, but it will not show copied or guessed codes until a current source or live test confirms the reward.
              </p>
            </article>
          ) : null}
