    ...
    (
      <div
        style={{
          ...
          background: "linear-gradient(135deg, #101114 0%, #192335 58%, #111113 100%)",
          color: "white",
          padding: 72
        }}
      >
        <div style={{ fontSize: 34, color: "#facc15", fontWeight: 800 }}>Official-link status</div>
        <div style={{ marginTop: 24, fontSize: 72, lineHeight: 1, fontWeight: 900 }}>{`${siteConfig.gameName} Trello & Discord`}</div>
        <div style={{ marginTop: 28, maxWidth: 920, fontSize: 30, lineHeight: 1.35, color: "rgba(255,255,255,0.74)" }}>
          Roblox, Trello, Discord, wiki, and source-watch checks.
        </div>
      </div>
    ),
    size
