    ...
    <main className="mx-auto max-w-7xl px-4 py-10">
      ...
      <section className="mt-10">
        <SectionHeader
          ...
          copy="Compare source checks, survival prep, guide priorities, and update-sensitive notes with clear labels for what still needs verification."
        />
      ...
      <section className="mt-10">
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-3">
          <Link href="/guides" className="content-card">
            ...
            <p className="mt-2 text-sm text-white/66">Use guides for tasks, danger signs, endings, badges, and store-area routes after the full detail list is confirmed.</p>
          </Link>
